...
class ViewPersonalNetworkConnectionsSerializer(serializers.Serializer):
...
class ViewPersonalNetworkInviteeSerializer(serializers.ModelSerializer):
    ...
    source = serializers.ReadOnlyField(default='personal_network')
...
class ViewPersonalNetworkInvitorSerializer(serializers.ModelSerializer):
    name = serializers.SerializerMethodField()
...
class PNInviteeSerializer(serializers.ModelSerializer):
    name = serializers.SerializerMethodField()
...
class PNInvitorSerializer(serializers.ModelSerializer):
    name = serializers.SerializerMethodField()
    ...
    def get_mutual_friends(self, obj):
        network1 = obj.invitee.social_network_invitor.filter(accepted=True)
        network2 = obj.invitee.social_network_invitee.filter(accepted=True)
        network3 = obj.invitor.social_network_invitor.filter(accepted=True)
        network4 = obj.invitor.social_network_invitee.filter(accepted=True)
...
class PersonalNetworkSerializer(serializers.ModelSerializer):
    class Meta:
        model = SocialNetwork
        fields = "__all__"
