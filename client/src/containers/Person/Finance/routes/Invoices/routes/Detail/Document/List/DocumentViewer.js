...
import ReceiptViewerWrapper, {ImageViewWrapper, PdfViewWrapper} from './DocumentViewer.style';
...
const InvoiceDocumentViewer = ({document}) => {
...
InvoiceDocumentViewer.defaultProps = {
  document: {}
}
