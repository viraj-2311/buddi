...
const ContractorInvoicePreview = React.forwardRef(({ invoice }, ref) => {
  ...
  const handleDownloadInvoice = async () => {
    dispatch(fetchDownloadInvoiceRequest(invoice?.id, `Invoice_${invoice?.invoiceMemo?.fullName}.pdf`));
          ...
          <div className='invoice-content'>
            <Row className='invoice-content-header'>
              <Col md={16} className='invoice-content-left'>
                ...
                <Row className='job-detail'>
                  <Col md={10}>
                    {invoice.job.jobNumber && <><strong>Gig #</strong>
              ...
              >
                ...
                <p>
                  ...
                  <br />
                  <span>
                    {billFrom.city}, {billFrom.state} {billFrom.zipCode}
                  </span>
                </p>
                <br />
                <p>
            ...
            <Row className='invoice-content-info'>
              <Col className='invoice-content-info-recipient' span={16}>
                <h3>Bandleader</h3>
                <h3>{billTo.name}</h3>
                <p>
                  ...
                  <br />
                  <span>
                    {billTo.city}, {billTo.state} {billTo.zipCode}
                  </span>
                </p>
                <p>
              ...
              <Col className='invoice-content-info-invoice-data' span={8}>
                <Row>
                  <Col span={10}>
                  ...
                  <tbody className='ant-table-tbody'>
                    <tr>
                      ...
                      {invoice.invoiceMemo.priceType ===
                        ...
                        <td> <CurrencyText
                        value={invoice.invoiceMemo.projectRate}
                      /></td>
                      )}
                      {invoice.invoiceMemo.priceType ===
            ...
            <Row className='invoice-content-notes'>
              <Col className='invoice-content-notes-text' span={16}>
                {/* <strong>Notes:</strong> */}
                {/* <br />
                <p>
              ...
              <Col className='invoice-content-notes-amount-due' span={8}>
                <div>
