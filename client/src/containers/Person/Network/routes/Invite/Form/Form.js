...
import PersonalNetworkInviteFormWrapper from './Form.style';
...
const PersonalNetworkInviteForm = () => {
  const dispatch = useDispatch();
  const {user: authUser} = useSelector(state => state.Auth);
  const { loading, professionals } = useSelector(state => state.PersonalNetwork.invite);
  ...
  return (
    <PersonalNetworkInviteFormWrapper>
...
export default PersonalNetworkInviteForm;
