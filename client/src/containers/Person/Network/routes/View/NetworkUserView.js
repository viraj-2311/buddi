...
import PersonalNetworkUserViewWrapper from './NetworkUserView.style';
...
const PersonalNetworkUserView = ({ userId }) => {
  ...
  return (
    <PersonalNetworkUserViewWrapper>
      ...
      <Box title='Production Companies' className='productionCompanySection'>
        <ContentHolder>
...
export default PersonalNetworkUserView;
