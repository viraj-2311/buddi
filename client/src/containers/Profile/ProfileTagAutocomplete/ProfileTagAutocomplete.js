...
import ProfileTagAutocompleteWrapper from './ProfileTagAutocomplete.style';
import ReactTags from 'react-tag-autocomplete';
import Tag from '@iso/components/uielements/tag';
const delimiters = ['Enter', 'Tab', ','];

const ProfileTagAutocomplete = ({tags, suggestions, placeholder, maxLength, onChange}, ref) => {
...
ProfileTagAutocomplete.defaultProps = {
  tags: [],
  suggestions: []
};

export default forwardRef(ProfileTagAutocomplete);
