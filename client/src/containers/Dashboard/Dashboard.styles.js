...
export const DashboardContainer = styled.div`
  ...
  .producerLayout .isomorphicTopbar {
    /* padding: ${(props) =>
      props['data-rtl'] === 'rtl' ? '0 317px 0 31px' : '0 31px 0 317px'}; */
  }
  .overlay-cover {
  ...
  .contractorLayout .isomorphicTopbar {
    /* padding: ${(props) =>
      props['data-rtl'] === 'rtl' ? '0 259px 0 31px' : '0 31px 0 259px'}; */
  }
...
export const PopupOverIntro = createGlobalStyle`
