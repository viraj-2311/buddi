...
export const WalletFailedStatus = [
  'review',
  'failed',
  'documents_required',
  'member_failed',
...
export const checkStatusFailed = (status) => {
  for (let i = 0; i < WalletFailedStatus.length; i++) {
    if (WalletFailedStatus[i] === status) {
      return true;
    }
  }
  return false;
...
export const RoleMembers = {
  ...
  controlling_officer: 'Band Owner',
};

export const ListRoleMembers = [
  { value: 'administrator', title: 'Administrator' },
  { value: 'beneficial_owner', title: 'Beneficial owner' },
  { value: 'controlling_officer', title: 'Band Owner' },
];
...
export const WalletAccessRole = {
  ADMIN: 'administrator',
  BENEFICIAL_OWNER: 'beneficial_owner',
  CONTROLLING_OFFICER: 'controlling_officer',
  CONTRACTOR_PRODUCER: 'CONTRACTOR',
