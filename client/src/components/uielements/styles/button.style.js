...
const Buttons = (ComponentName) => styled(ComponentName)`
  &.ant-btn {
    ...
    &.ant-btn-primary {
      ...
      background-image: ${(props) => props['hideBackGroundImage'] && 'none'};
    ...
    &.type-two {
      background-color: rgba(255, 192, 106, 1);
      border-color: rgba(255, 192, 106, 1);
      color: #ffffff;
      &:hover {
        background-color: rgba(255, 192, 106, 0.8);
        border-color: rgba(255, 192, 106, 0.8);
      }
    }

    &.ant-btn-white-style {
      background-image: linear-gradient( to right, #c5370f -10%, #e17f08 112% ) !important;
      border-color: #f48d3a;
      color: #fff;
    }
  ...
  &.ant-btn-group {
    .ant-btn {
      ...
      &.ant-btn-primary {
        ...
        &:hover,
        &:focus {
          border-color: ${palette('themecolor', 10)};
        }
      }
    }
